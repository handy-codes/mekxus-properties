    ...
    <div>
      ...
      <div className='flex flex-col gap-5 p-28 px-3 max-w-6xl mx-auto mb-[-150px] mt-[-70px]'>
        ...
        <div className='text-black text-xs sm:text-sm'>
          <p className='text-[16px] text-justify'>Mekxos is a Nigerian startup PropTech. The Web App is developed by the founder <a className='text-blue-700 font-bold underline' href="https://emekaowo-portfolio.netlify.app">Emeka Owo</a> to be a leading real estate company that specializes in helping clients buy, sell, and rent properties in the most desirable neighborhoods. Our team of experienced agents is dedicated to providing exceptional services and making the process of buying and selling properties as smooth as possible.</p>
          <br />
